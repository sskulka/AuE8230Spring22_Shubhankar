...
set(MSG_I_FLAGS "-Irosaria:/home/sskulka/catkin_ws/src/rosaria/msg;-Igeometry_msgs:/opt/ros/noetic/share/geometry_msgs/cmake/../msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/sskulka/catkin_ws/src/rosaria/msg/BumperState.msg" NAME_WE)
add_custom_target(_rosaria_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rosaria" "/home/sskulka/catkin_ws/src/rosaria/msg/BumperState.msg" "std_msgs/Header"
)
...
_generate_msg_cpp(rosaria
  "/home/sskulka/catkin_ws/src/rosaria/msg/BumperState.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rosaria)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rosaria\")")
  # install generated code
  install(
